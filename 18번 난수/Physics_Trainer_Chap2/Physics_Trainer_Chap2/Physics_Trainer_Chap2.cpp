...

{
...

    {
        ...
        printf("Δt = Δv / a, v : 나중속도, v0 : 초기속도, a : 가속도\n");
        printf("Δx = x - x0, x : 나중위치, x0 : 초기위치\n");
        ...
        printf("x4 =(%6.2lf km/h/3.6) * %6.2lf s + 1/2 * (-%6.2lf m/s^2) * (%6.2lf s)^2\n", velocity_m_s, time_4, a, time_4);

        x_4_distance = (velocity_m_s / b) * time_4 + (-a / 2 * time_4 * time_4);

        printf("   = %6.2lf m\n\n", x_4_distance);

        printf("x5 =(%6.2lf km/h/3.6) * %6.2lf s + 1/2 (-%6.2lf m/s^2) * (%6.2lf s)^2\n", velocity_m_s, time_5, a, time_5);
