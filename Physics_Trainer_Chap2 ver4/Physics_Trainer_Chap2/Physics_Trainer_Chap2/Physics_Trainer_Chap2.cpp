...

{
...

    {
        ...
        printf("여기서 ( Δy = (높이) = 15 m ), ( v = 나중 속도 ), ( v0 = (처음 속도) = 22.0 m/s ), ( a(중력 가속도) = 9.80 m/s^2 ) 입니다.\n\n");
...

    {
        ...
        printf("위로 던진 돌이%6.2lf m을 지나 최고점에서 정지하고 아래로 떨어지면서 다시%6.2lf m을 지나기 때문에 두 개의 식이 나옵니다.\n\n", height, height);
        ...
        printf("첫 번째 식을 풀면 %6.2lf m/s -%6.2lf m/s = -%6.2lf m/s^2 * t1 이 되고\n\n", v, velocity, g);
        printf("t1 = (%6.2lf m/s - %6.2lf m/s) / - %6.2lf m/s^2 이 됩니다.\n\n", v, velocity, g);

        printf("두 번째 식을 풀면 -%6.2lf m/s -%6.2lf m/s = -%6.2lf m/s^2 * t2 이 되고\n\n", v, velocity, g);
